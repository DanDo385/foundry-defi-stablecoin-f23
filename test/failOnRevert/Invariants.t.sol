 ...
 * @title Invariants
 * @author Dan Magro
 * @notice Invariant tests with failOnRevert policy
 * @dev Stricter tests - fails immediately if any call reverts
 * This ensures all operations succeed with conservative bounds
 */
